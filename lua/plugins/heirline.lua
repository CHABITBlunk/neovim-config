return {
  ...
  event = "BufEnter",
  opts = function()
    local status = require "habit.utils.status"
    return {
      opts = {
        disable_winbar_cb = function(args)
          return not require("habit.utils.buffer").is_valid(args.buf)
      ...
      tabline = {
        ...
        status.component.fill { hl = { bg = "tabline_bg" } }, -- fill rest of tabline with background
        { -- tab list
