return function(_, opts)
  ...
  local C = require("habit.utils.status.env").fallback_colors
  local get_hlgroup = require("habit.utils").get_hlgroup
  local lualine_mode = require("habit.utils.status.hl").lualine_mode
