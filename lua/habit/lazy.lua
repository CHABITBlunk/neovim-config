...
if not (vim.uv or vim.loop).fs_stat(lazypath) then -- todo remove when migrating >0.9
  ...
  vim.api.nvim_create_autocmd("User", {
    ...
    callback = function()
      ...
      vim.tbl_map(function(module) pcall(require, module) end, { "nvim-treeistter", "mason" })
